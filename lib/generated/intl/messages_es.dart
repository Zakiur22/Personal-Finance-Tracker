...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "categoriesScreenSnackbarTextResetCategoriesAction":
        MessageLookupByLibrary.simpleMessage("Si"),
    "categoriesScreenSnackbarTextResetCategoriesConfirmation":
        MessageLookupByLibrary.simpleMessage(
          "Seguro que quieres restaurar todas las categorías a los valores por defecto?",
        ),
    "categoriesScreenSnackbarTextResetCategoriesSuccess":
        MessageLookupByLibrary.simpleMessage(
          "Todas las categorías fueron restauradas satisfactoriamente",
        ),
    ...
    "currenciesScreenSnackbarTextResetCurrenciesConfirmation":
        MessageLookupByLibrary.simpleMessage(
          "Seguro que quieres restaurar todas las monedas a los valores por defecto?",
        ),
    "currenciesScreenSnackbarTextResetCurrenciesSuccess":
        MessageLookupByLibrary.simpleMessage(
          "Todas las monedas fueron restauradas satisfactoriamente",
        ),
    ...
    "deleteAccountDialogContent": MessageLookupByLibrary.simpleMessage(
      "Perderás todos los datos (incluyendo información del perfil y tu historial de transacciones) cuando borres tu cuenta. Este es un proceso irreversible, estas seguro que deseas llevarlo a cabo?",
    ),
    "deleteAccountDialogTitle": MessageLookupByLibrary.simpleMessage(
      "De verdad quieres borrar tu cuenta?",
    ),
    ...
    "homeDailyNoTransactionsTextSubtitle": MessageLookupByLibrary.simpleMessage(
      "Toca el botón + de abajo para añadir un nuevo ingreso/gasto.",
    ),
    "homeDailyNoTransactionsTextTitle": MessageLookupByLibrary.simpleMessage(
      "Esta lista se ve un poco vacía...",
    ),
    ...
    "loginTextTagline": MessageLookupByLibrary.simpleMessage(
      "Be Thrifty Today es una aplicación de administración de dinero simple y segura que te ayuda a rastrear tus ingresos y gastos.",
    ),
    ...
    "settingsScreenSettingTitleBiometric": MessageLookupByLibrary.simpleMessage(
      "Fortificación Biometrica",
    ),
    "settingsScreenSettingTitleBiometricDescription":
        MessageLookupByLibrary.simpleMessage(
          "Solicita tu huella digital cada vez que abres la app.",
        ),
    ...
    "settingsScreenSettingTitleEmailAddress":
        MessageLookupByLibrary.simpleMessage("Dirección de correo"),
    ...
    "thriftyDrawerMessageShare": MessageLookupByLibrary.simpleMessage(
      "Checa esta app que te ayuda a administrar tus ingresos y gastos de forma segura: https://pillai.xyz/thrifty",
    ),
    ...
    "thriftyDrawerTextAboutAppLegalese": MessageLookupByLibrary.simpleMessage(
      "Esta aplicación es de codigo abierto y gratuita, gobernada por la Apache License 2.0. Si eres desarrollador por favor sientete libre de contribuir a esta app en GitHub.",
    ),
    "thriftyDrawerTextAboutFooter": MessageLookupByLibrary.simpleMessage(
      "Si te gusta la app y la usas regularmente, por favor dona lo que puedas, esto es suficiente para mantener la app viva y corriendo por si misma. Los detalles para donaciónes pueden encontrarse en la pagina de GitHub del proyecto o en el sitio web. Muchas gracias!",
    ),
    ...
    "thriftyDrawerTextLogout": MessageLookupByLibrary.simpleMessage(
      "Cerrar sesión",
    ),
    ...
    "thriftyOverviewTextBudgetUnset": MessageLookupByLibrary.simpleMessage(
      "Toca aquí para establecer un presupuesto mensual y administrar tus gastos eficientemente.",
    ),
    "transactionBottomSheetButtonTextAdd": MessageLookupByLibrary.simpleMessage(
      "AGREGAR",
    ),
    "transactionBottomSheetButtonTextExpense":
        MessageLookupByLibrary.simpleMessage("Gasto"),
    "transactionBottomSheetButtonTextIncome":
        MessageLookupByLibrary.simpleMessage("Ingreso"),
    ...
    "transactionBottomSheetTextHeadingAdd":
        MessageLookupByLibrary.simpleMessage("Agregar nueva transacción"),
    "transactionBottomSheetTextHeadingUpdate":
        MessageLookupByLibrary.simpleMessage("Actualizar transacción"),
    "transactionListHiddenTransactionText": m3,
    "updateBudgetBottomSheetButtonTextClear":
        MessageLookupByLibrary.simpleMessage("LIMPIAR"),
    "updateBudgetBottomSheetButtonTextSetBudget":
        MessageLookupByLibrary.simpleMessage("ESTABLECER PRESUPUESTO"),
    "updateBudgetBottomSheetHeadingText": MessageLookupByLibrary.simpleMessage(
      "Por favor ingresa un presupuesto mensual que creas que es moderado de acuerdo a tus habitos de gasto.",
    ),
    "updateBudgetBottomSheetLabelTextBudget":
        MessageLookupByLibrary.simpleMessage("Presupuesto"),
  };
}
