...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "categoriesScreenSnackbarTextResetCategoriesSuccess":
        MessageLookupByLibrary.simpleMessage(
          "Toutes les catégories ont bien été réinitialisées",
        ),
    ...
    "currenciesScreenSnackbarTextResetCurrenciesConfirmation":
        MessageLookupByLibrary.simpleMessage(
          "Êtes-vous sûr de vouloir réinitialiser toutes les devises?",
        ),
    "currenciesScreenSnackbarTextResetCurrenciesSuccess":
        MessageLookupByLibrary.simpleMessage(
          "Toutes les devises ont bien été réinitialisées",
        ),
    ...
    "deleteAccountDialogButtonTextDelete": MessageLookupByLibrary.simpleMessage(
      "Oui, supprimez mes données!",
    ),
    "deleteAccountDialogContent": MessageLookupByLibrary.simpleMessage(
      "Vous allez perdre toutes vos données (dont vos informations publiques and votre historique de transactions) si vous supprimez votre compte. C\'est un processus irréversible, êtes-vous sûr de le vouloir ?",
    ),
    ...
    "homeDailyNoTransactionsTextTitle": MessageLookupByLibrary.simpleMessage(
      "Cette liste à l\'air un peu vide...",
    ),
    ...
    "loginTextTagline": MessageLookupByLibrary.simpleMessage(
      "Be Thrifty Today est une application simple et sécurisée pour gérer votre budget. Elle vous aide à suivre vos dépenses et vos revenus.",
    ),
    ...
    "settingsScreenSettingTitleAccentColor":
        MessageLookupByLibrary.simpleMessage("Couleur d\'accentuation"),
    ...
    "settingsScreenSettingTitleBiometricDescription":
        MessageLookupByLibrary.simpleMessage(
          "Demande votre empreinte digitale à chaque ouverture de l\'application.",
        ),
    ...
    "thriftyDrawerMessageShare": MessageLookupByLibrary.simpleMessage(
      "Découvrez cette application qui vous aide à gérer vos revenus et vos dépenses en toute sécurité: https://pillai.xyz/thrifty",
    ),
    ...
    "thriftyDrawerTextAboutAppLegalese": MessageLookupByLibrary.simpleMessage(
      "Cette application, gratuite et open-source, est régie par la licence Apache 2.0. Si vous êtes développeur, n\'hésitez pas à contribuer à l\'application sur GitHub.",
    ),
    "thriftyDrawerTextAboutFooter": MessageLookupByLibrary.simpleMessage(
      "Si vous aimez l\'application et l\'utilisez régulièrement, vous pouvez faire une donation du montant que vous voulez, juste assez pour que l\'application vive et fonctionne de manière autonome. Vous pouvez trouvez les détails sur la page Github ou sur le site. Merci beaucoup!",
    ),
    ...
    "thriftyOverviewTextBudgetUnset": MessageLookupByLibrary.simpleMessage(
      "Cliquez ici pour définir un budget mensuel, afin de gérer efficacement vos dépenses.",
    ),
    "transactionBottomSheetButtonTextAdd": MessageLookupByLibrary.simpleMessage(
      "AJOUTER",
    ),
    "transactionBottomSheetButtonTextExpense":
        MessageLookupByLibrary.simpleMessage("Dépense"),
    "transactionBottomSheetButtonTextIncome":
        MessageLookupByLibrary.simpleMessage("Revenu"),
    ...
    "transactionBottomSheetLabelTextDescription":
        MessageLookupByLibrary.simpleMessage("La Description (facultative)"),
    "transactionBottomSheetTextHeadingAdd":
        MessageLookupByLibrary.simpleMessage(
          "Ajouter une nouvelle transaction",
        ),
    "transactionBottomSheetTextHeadingUpdate":
        MessageLookupByLibrary.simpleMessage("Mettre à jour la transaction"),
    ...
    "updateBudgetBottomSheetButtonTextSetBudget":
        MessageLookupByLibrary.simpleMessage("DÉFINIR UN BUDGET"),
    "updateBudgetBottomSheetHeadingText": MessageLookupByLibrary.simpleMessage(
      "Veuillez indiquer un budget mensuel proportionnel à vos habitudes de dépenses.",
    ),
    "updateBudgetBottomSheetLabelTextBudget":
        MessageLookupByLibrary.simpleMessage("Budget"),
  };
}
